...
{
    /// <inheritdoc />
    public partial class alsd : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LeaveFrom = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    LeaveTo = table.Column<string>(type: "nvarchar(max)", nullable: true),
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserInformations", x => x.EmployeeId);
                });
        }
    }
}
